            ...
            <article class="pro-player-card">
              ...
              <div class="pro-player-body">
                <div class="pro-mini-badges">
                  ...
                  ${player.available_immediately ? `<span class="pro-mini-badge pink">Tournament Pickup</span>` : ""}
        ...
        <section class="pro-hero">
          ...
          <div>
            ...
            <div class="pro-badges">
              ${player.looking_for_team ? `<span class="pro-badge pink">Season Team Available</span>` : ""}
              ${player.available_immediately ? `<span class="pro-badge">Tournament Pickup Available</span>` : ""}
        ...
        <div class="pro-layout">
          <div class="pro-main">
            <section class="pro-quick-grid">
              ...
              <article class="pro-card">
                <h3>Opportunity</h3>
                <p><strong>Season-long team:</strong> ${player.looking_for_team ? "Available" : "Not available"}</p>
                <p><strong>Tournament pickup:</strong> ${player.available_immediately ? "Available" : "Not available"}</p>
